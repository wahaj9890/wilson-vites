export const clearLocalStorage = () => {
  ...
  localStorage.removeItem("ReturnReasonsScene_Damage_true_coolingOff_false");
  localStorage.removeItem("ReturnReasonsScene_Damage_false_coolingOff_true");
  localStorage.removeItem("ReturnReasonsScene_Damage_false_coolingOff_false");
};
